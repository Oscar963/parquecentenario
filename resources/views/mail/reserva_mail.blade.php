...
<head>
  ...
  <title>Reserva de Quincho</title>
    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              {{ $nombre }}, Tu reserva ha sido registrada.
            </td>
          </tr>
          <tr>
            <td class="free-text">
              Queremos informarle que acabamos de recibir su reserva para el quincho <a href="">Nº {{ $nQuincho }}</a>. Encontrarás todos los detalles a continuación.
            </td>
          </tr>
          <tr>
            <td class="w320">
                      ...
                      <tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                <span class="header-sm">Datos Personales</span><br />
                                Nombre: {{ $nombre }}<br />
                                Rut: {{ $rut }} <br />
                                Dirección: {{ $direccion }} <br />
                                Correo: {{ $correo }} <br />
                                Telefóno: {{ $telefono }} <br />
                              </td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                <span class="header-sm">Datos de la reserva</span><br />
                                Código: <strong>{{ $codigo }}</strong> <br />
                                Fecha: {{ $fecha }}<br />
                                Hora de llegada: {{ $hora }} <br />
                                <br />
                                <span class="header-sm">Datos del Quincho</span> <br />
                                Nº Quincho : {{ $nQuincho }}
                              </td>
                            </tr>
                          </table>
